...
def parse_args():
    ...
    parser.add_argument("--capture-video", type=lambda x: bool(strtobool(x)), default=False, nargs="?", const=True,
        help="if toggled, video of the environment would be recorded")
...
if __name__ == "__main__":
    ...
    #     if 'final_info' in info and isinstance(info['final_info'], (list, np.ndarray)):
    #         for item in info['final_info']:
    #             if isinstance(item, dict) and 'episode' in item:
    #                 print(f"Episode return: {item['episode']['r']}")
